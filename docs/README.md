...
Ideias futuras ficam identificadas como roadmap. Isso evita que a documentação prometa um executor,
agente ou frontend que ainda não está disponível no repositório.
